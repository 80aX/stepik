...
# Примечание:
# ﻿Работа с файлами рассмотрена в следующем уроке, поэтому вы можете вернуться к этой задаче 
# после просмотра следующего урока.
...
with open('passwords.txt', 'r') as inf:
    for line in inf:
        ...
        print('trying: ' + line)
        try:
            plaintext = decrypt(line, ciphertext)
        except:
            pass


print('result as string: %s' % plaintext.decode('utf8'))
