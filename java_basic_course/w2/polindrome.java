...
// знаки препинания, а также регистр символов должны игнорироваться. Гарантируется, что в метод 
// попадают только строки, состоящие из символов ASCII (цифры, латинские буквы, знаки препинания). 
...
public class polindrome {
    ...
    public static boolean isPalindrome(String text) {
        String afterRegExp = text.replaceAll("[^a-zA-Z0-9]", "");
        StringBuilder builder = new StringBuilder(afterRegExp);
